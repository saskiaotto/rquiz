...
#'
#' Any white space in the string will be correctly displayed in the cloze text, but not a tab stop
#' or line break. To display a line break in the quiz use the \strong{<br>} tag.
#'
#'
