...
#'             when \code{showTipButton = TRUE}. If omitted, the number of correct
#'             answers is shown as the default tip.
#'        }
...
#'        \code{"fr"} (French), and \code{"es"} (Spanish). To request additional languages,
