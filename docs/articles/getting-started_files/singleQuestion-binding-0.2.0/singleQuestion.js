  ...
  factory: function(el, width, height) {
    ...
    return {
      ...
      renderValue: function(x) {
        ...
        // TITLE (as header div, similar to fillGaps)
        var qTitle = title;
        if (qTitle !== "NULL") {
          var divHeader = document.createElement("div");
          divHeader.classList.add("sqq-header");
        ...
        function letterHover(row) {
          ...
          row.addEventListener('mouseenter', function() {
            letterEl.style.backgroundColor = "#2677B6";
          });
          row.addEventListener('mouseleave', function() {
            letterEl.style.backgroundColor = "#469BDC";
          });
        }
        ...
        function isCorrect() {
          ...
          document.querySelector(`#${widgetId} .sqq-question-p`).style.color = "white";
        }
        ...
        if (quizType === "single") {
          ...
          function resetFeedback() {
            ...
            document.querySelector(`#${widgetId} .sqq-question-p`).style.color = questionCol;
          ...
          mcButtons.classList.add("sqq-mc-buttons");
          ...
          submitBtn.style.color = x.submitBtnCol;
          submitBtn.style.backgroundColor = x.submitBtnBg;
          ...
          if (showTipBtn === "true") {
            ...
            tipBtn.classList.add("sqq-mc-btn");
            ...
            tipBtn.style.color = x.tipBtnCol;
            tipBtn.style.backgroundColor = x.tipBtnBg;
          ...
          if (showSolutionBtn === "true") {
            ...
            solutionBtn.classList.add("sqq-mc-btn");
            ...
            solutionBtn.style.color = x.solutionBtnCol;
            solutionBtn.style.backgroundColor = x.solutionBtnBg;
