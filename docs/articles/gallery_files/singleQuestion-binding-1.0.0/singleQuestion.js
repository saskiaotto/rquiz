  ...
  factory: function(el, width, height) {
    ...
    return {
      ...
      renderValue: function(x) {
        ...
        pQuestion.style.padding = questionFontSize*0.4+ 'px 20px';
        ...
        if (quizType === "single") {
          ...
          if (scShowTipBtn === "true" || scShowSolutionBtn === "true") {
            ...
            scButtons.classList.add("sqq-mc-buttons");
          ...
          setImportant(submitBtn, 'color', x.submitBtnCol);
          setImportant(submitBtn, 'background-color', x.submitBtnBg);
          setImportant(submitBtn, 'background-image', 'none');
          setImportant(submitBtn, 'border-color', x.submitBtnBg);
