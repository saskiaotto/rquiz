  ...
  factory: function(el, width, height) {
    ...
    return {
      ...
      renderValue: function(x) {
        ...
        divHeader.classList.add("fbq-header");
        ...
        if (title !== "NULL") {
          ...
          pTitle.classList.add("fbq-title");
        ...
        if (descript !== "NULL") {
          ...
          pDescript.classList.add("fbq-description");
        ...
        setImportant(buttonSubmit, 'color', submitBtnCol);
        setImportant(buttonSubmit, 'background-color', submitBtnBg);
        setImportant(buttonSubmit, 'background-image', 'none');
        setImportant(buttonSubmit, 'border-color', submitBtnBg);
