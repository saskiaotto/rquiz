  ...
  factory: function(el, width, height) {
    ...
    return {
      ...
      renderValue: function(x) {
        ...
        // Tip div below options (separate from option-block-container)
        if (x.showTipBtn === "true") {
          ...
          divFieldset.appendChild(tipDiv);
        }
        ...
        var quizApp = function() {
              ...
              if (typeof userSelections !== 'undefined' && userSelections[this.currentque] != null) {
                ...
                if (quizType === "multiple" && Array.isArray(saved)) {
                  ...
                  saved.forEach(function(val) {
                    var cb = widgetEl.querySelector('.mqq-option-block-container input[type=checkbox][value="' + val + '"]');
                    if (cb) {
                      cb.checked = true;
                  ...
                  var rb = widgetEl.querySelector('.mqq-option-block-container input[type=radio][value="' + saved + '"]');
                  if (rb) {
                    rb.checked = true;
          ...
          // Function that shows the results
            ...
            // Hide tip button and div on results page
